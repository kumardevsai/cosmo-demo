...
str+='<a href="../include/%27+url+%27" style="width:100%;height:100%;display:block"></a>';str+='</div>';el.innerHTML=str;$me.onwrite(curVideo.getFullVid());$me.oninited();},function(errCode){$me.onerror(errCode);$me.onwrite(curVideo.getFullVid());$me.oninited();});}}
